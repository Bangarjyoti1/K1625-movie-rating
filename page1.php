...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../movie/css/page1.css">
	<script>
...
<div class="col">
	<div class="rightside"> 
	<div class="b1">
		<div><u><h2 class="h1">Login</h2></u>
			<div class="butt">
		<button><a href="../movie/addmovie.php">Administration Login</a></button>
		<button><a href="../movie/login.php">Customer Login</a></button>
